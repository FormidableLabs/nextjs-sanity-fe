...
declare module "../groq-builder" {
  export interface GroqBuilder<TScope, TRootConfig extends RootConfig> {
    filterBy<TKey extends keyof ArrayItem<TScope>, TValue extends ArrayItem<TScope>[TKey]>(
      filterString: `${StringKeys<TKey>} == "${Extract<TValue, string>}"`
    ): GroqBuilder<Array<Extract<ArrayItem<TScope>, { [P in TKey]: TValue }>>, TRootConfig>;
