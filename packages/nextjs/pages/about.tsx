    ...
    <div className="container py-9 grid grid-cols-1 md:grid-cols-2 gap-9 text-blue">
      <div className="order-1 flex flex-col gap-9 justify-between">
        ...
        <p>
          ...
          porro et magnam ut suscipit natus recusandae. Possimus voluptatem minima veniam doloribus dolor aut occaecati.
          Vitae doloremque minima. Temporibus animi accusamus.
        </p>
      </div>
      ...
      <div className="order-5 md:col-span-2 flex justify-center">
        <div className="max-w-4xl">
          ...
          <p>
            Enim unde et numquam laudantium similique officia non animi. Aut quia eveniet omnis velit labore porro. Non
            eum vitae laborum id velit labore. Itaque officia consequatur. Suscipit molestiae dolorem saepe modi sint.
            Qui rerum dicta explicabo omnis officia ut eligendi laborum.
          </p>
        </div>
      </div>
    </div>
